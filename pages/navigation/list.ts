  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          "基于 vue 的 PC 端表格库，支持增删改查、虚拟滚动、懒加载、快捷菜单、数据校验、树形结构、打印导出、表单渲染、数据分页、虚拟列表、模态窗口、支持右键菜单、自定义模板、渲染器、贼灵活的配置项、扩展接口、国际化、数据校验、数据汇总、大数据量优化、兼容 Vue 2.x、Vue 3.x、ElementUI、iView、Ant Design Vue、Vant、Vuetify、Bootstrap、Material Design、Tailwind CSS、Wind UI、Taro 等等",
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          "ECharts 是一个使用 JavaScript 实现的开源可视化库，可以流畅的运行在 PC 和移动设备上，兼容当前绝大部分浏览器（IE8/9/10/11，Chrome，Firefox，Safari等），底层依赖轻量级的 Canvas 类库 ZRender，提供直观，生动，可交互，可高度个性化定制的数据可视化图表",
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        description:
          "xgplayer 是一个支持多平台的开源 HTML5 播放器，支持 PC 和移动端浏览器，支持 H5 和 Flash 播放，支持弹幕，支持插件扩展，支持多语言，支持多种格式视频播放，支持自定义皮肤，支持自定义视频源，支持自定义播放器组件",
      },
      {
        title: "DPlayer",
        ...
        description:
          "DPlayer 是一个开源的、基于 HTML5 的播放器，支持弹幕、自动切换清晰度、自动滚动、镜像翻转、翻转模式、硬解、截图、无缝切换视频、帧预览、记忆播放位置、精确跳跃、截图、logo、封面、窗口模式、弹幕各种配置项、多实例等等",
      },
      {
      ...
      },
      {
        ...
        description:
          "video.js 是一个开源的网络视频播放器，支持 HTML5 和 Flash 播放，支持自定义皮肤，支持自定义插件，支持自定义播放器组件，支持多语言，支持多种格式视频播放，支持自定义视频源，支持自定义播放器组件",
      },
      {
    ...
    children: [
      {
        ...
        link: "https://antfu.me/",
        description:
          "Anthony Fu，一个狂热的开源爱好者。Vitest、Slidev、VueUse、UnoCSS、Elk、Type Challenges 等的创建者。Vitest、Slidev、VueUse、UnoCSS、Elk、Type Challenges 等的创建者。Vue、Nuxt、Vite 核心团队成员。Vue、Nuxt、Vite 核心团队成员。",
      },
      {
        title: "阮一峰",
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        description:
          "本站网盘分享（WPFX.ORG）只是一个综合性的网盘云盘资源分享共享网站。如音乐、影视、软件、教程、文件，书籍等，全部免费获取资源！本站立志于免费提供全网最全面的资源整合。网站内容来源于互联网收集，仅仅只适用于学习和交流测试。所有资源链接全部跳转到第三方网盘网站，本站不存储任何网盘云盘资料。",
      },
      {
        title: "WebStorm激活",
...
export const adminList: NavigationLink[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: "https://naive-ui-admin.vercel.app/favicon.ico",
        link: "https://www.naiveadmin.com/",
        github: "https://github.com/jekip/naive-ui-admin?tab=readme-ov-file",
        description:
...
export const toolsList: NavigationLink[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        title: "stylelint",
        icon: "https://cdn.worldvectorlogo.com/logos/stylelint.svg",
